/**
 * Modal de création de nouvelles demandes pour l'admin
 */
...
import { 
  ...
  FiFileText, FiPlus, FiCheckCircle
} from 'react-icons/fi'
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Créer une nouvelle demande pour un utilisateur
                  </p>
                </div>
              </div>
              <button
                ...
                >
                  {usersLoading ? (
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                      <option value={0}>Sélectionner un demandeur</option>
                      {users?.map((user: any) => (
                ...
                >
                  {usersLoading ? (
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                      <option value={0}>Aucun agent assigné</option>
                      {users?.filter((user: any) => 
                        ['ADMIN', 'SUPERADMIN', 'AGENT_CONSULAIRE', 'AGENT_RDV'].includes(user.role)
                      ).map((user: any) => (
                        <option key={user.id} value={user.id}>
